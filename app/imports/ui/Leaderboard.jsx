...
export const Leaderboard = ({ roundId }) => {
  ...
  return (
    ...
    >
      <h2 style={{ textAlign: 'center', marginBottom: '14px', letterSpacing: '2px' }}>LEADERBOARD</h2>
      <p style={{ textAlign: 'center', color: '#ccc', fontSize: '0.85rem', marginBottom: '14px' }}>
        Player lives update live as the round finishes
      </p>

      {leaderboard.length === 0 ? (
        <p style={{ textAlign: 'center', color: '#ccc' }}>Waiting for players to finish...</p>
      ) : (
          ...
          return (
            <div
              ...
              style={{
                ...
                backgroundColor: isAlive ? 'rgba(0, 200, 100, 0.15)' : 'rgba(150, 150, 150, 0.15)',
                border: isAlive ? '1px solid rgba(0, 200, 100, 0.3)' : '1px solid rgba(150, 150, 150, 0.3)',
              }}
            >
