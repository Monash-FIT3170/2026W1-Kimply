...
import { RainbowBar, GhostButton, TileLattice, IconChip, BG, HAIRLINE, ACCENT } from '../components/design';
...
function PrimaryButton({ children, onClick }) {
  return (
    <button
      onClick={onClick}
      className="flex-1 cursor-pointer rounded-[10px] border-none px-4 py-[11px] font-outfit text-[11px] font-extrabold uppercase tracking-[0.08em] transition-all duration-150 hover:-translate-y-px"
      style={{
        background: ACCENT,
...
export function ReconnectPopup({ isOpen, onReconnect, onDismiss, gameId }) {
  ...
  return (
    ...
    >
      <div
        className="relative flex w-[420px] max-w-[calc(100vw-32px)] flex-col overflow-hidden rounded-[18px] border border-hairline font-outfit"
        style={{
          background: BG,
      ...
      >
        ...
        <div className="p-[26px]">
          ...
          <h2 className="mb-2.5 text-[17px] font-extrabold uppercase tracking-[0.05em] text-fg">Rejoin your game?</h2>
          ...
          <div
            className="mb-[22px] inline-flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-[12px] font-bold uppercase tracking-[0.06em]"
            style={{
          ...
          <div className="-mx-[26px] mb-5 h-px bg-hairline opacity-60" />
