      ...
      >
        ...
        <div className="relative overflow-hidden">
          ...
          <button
            ...
            className="absolute right-3 top-3 z-10 flex h-11 w-11 cursor-pointer items-center justify-center rounded-[9px] border border-hairline bg-transparent text-fg2 transition-colors hover:bg-white/5 hover:text-fg xs:h-[30px] xs:w-[30px]"
          >
            <CloseIcon />
          </button>
          ...
          <div className="relative z-[1] p-[26px]">
            ...
            <p className="mb-[22px] text-[13.5px] leading-[1.65] text-fg2">{message}</p>
